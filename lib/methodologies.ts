...
export const methodologies: Methodology[] = [
  {
    ...
    "hasSkill": true,
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/ai-requirements-analysis",
    "skillEffect": "输入一句模糊想法，直接产出需求定义、四维可行性评估、完整 PRD 和 MVP/灰度方案",
    "sourceUrl": "https://github.com/Alaraby527/ai-pm-methodology-notes",
  ...
  },
  {
    ...
    "example": "在火花工坊立项中完成三层竞品调研：直接竞品选 Coze、Dify、LiblibAI 做五层深研，间接竞品选知识星球、小报童、生财有术看商业模式，Notion AI、Discord、得到作为潜在标杆；用六维 UX 评分和功能矩阵对比后判断“直接竞品用户重叠低、应当技术底座，真正对手是私域社群”，输出 SWOT、战略象限和 P0/P1/P2 差异化清单",
    "hasSkill": true,
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/competitive-research",
    "skillEffect": "输入竞品名单，产出五层对比矩阵、SWOT、战略象限和破局优先级",
    "sourceUrl": "https://github.com/Alaraby527/ai-pm-methodology-notes",
  ...
  },
  {
    ...
    "hasSkill": true,
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/user-interview",
    "skillEffect": "给一个研究目标，产出访谈提纲、三级编码表和带用户原话的洞察结论",
    "sourceUrl": "https://github.com/Alaraby527/ai-pm-methodology-notes",
    "tagline": "别猜用户怎么想，去问"
  },
  {
    ...
    "hasSkill": true,
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/product-experience-report",
    "skillEffect": "指定一款产品，按五要素逐层产出体验报告和可直接借鉴的设计点",
    "sourceUrl": "https://github.com/Alaraby527/ai-pm-methodology-notes",
  ...
  },
  {
    ...
    "hasSkill": true,
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/data-analysis",
    "skillEffect": "给一个异常指标，产出漏斗与分层根因分析、含 AI 质量指标的指标体系",
    "sourceUrl": "https://github.com/Alaraby527/ai-pm-methodology-notes",
  ...
  },
  {
    ...
    "hasSkill": true,
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/usability-testing",
    "skillEffect": "给测试目标，产出任务清单、按四级分级的问题清单和完整测试报告",
    "sourceUrl": "https://github.com/Alaraby527/ai-pm-methodology-notes",
    "tagline": "看人用，比自己想有用"
  },
  {
    ...
    "hasSkill": true,
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/survey-questionnaire",
    "skillEffect": "给要验证的假设，产出完整问卷、交叉分析方案和分层结论"
  },
  {
    ...
    "hasSkill": true,
    "skillEffect": "丢一个 SKILL.md，产出 8 维评分、分级问题清单和可执行改进项",
    "skillUrl": "https://github.com/Alaraby527/ai-pm-skills/tree/main/skills/skill-quality-checker"
  },
  {
