...
export const projects: Project[] =  [
  ...
  },
  {
    ...
    "title": "课件 RAG 问答机器人｜匹配率 5/15→15/15（没换模型）",
    "subtitle": "从 Dify 验证到微信公众号落地，528 张课件可问答",
    "role": "AI 产品实习生 @ 火花工坊",
    "projectType": "internship",
    "tier": "other",
    "summary": "40 天课程的 528 张课件都是图片，重复答疑占社群问题的 60%。我先在 Dify 用 Chatflow 搭 RAG 问答助手验证（16 篇文档、20 题黄金集 90% 通过），再把 528 张课件 OCR 化、用纯 Python 接入微信公众号。初版 15 题只命中 5 题，第一反应是换大模型但收效甚微；写脚本逐条分析失败 case，定位到是分块问题——长句 AND 匹配过严、口语和课件书面语对不上，改语义分块加同义词映射后做到 15/15，全程没换模型。",
    ...
    "detailCards": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "解法：按语义段落而非固定长度切分，增加同义词映射；检索匹配率从 5/15 提到 15/15，模型始终没换。"
        ]
      }
    ],
    "sourceUrl": "https://github.com/Alaraby527/huohuahub-ai-creator-platform",
