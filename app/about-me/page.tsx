...
const timelineData = [
  ...
  { id: 23, type: "主线任务", typeColor: "bg-[#FF6B7A]", date: "2025年12月", title: "第一份实习：采购实习生", description: "在上海自动化仪表有限公司担任采购实习生，负责采购合同全流程处理与供应商比价，借助AI将比价制作效率提升3倍。", side: "left" },
  { id: 24, type: "主线任务", typeColor: "bg-[#FF6B7A]", date: "2025年12月", title: "第二份实习：机械装配", description: "在物智进化担任机械装配实习生，参与舵机组装调参，提出流水线作业方案，生产效率提升10倍且编号零出错。", side: "left" },
  ...
  { id: 29, type: "主线任务", typeColor: "bg-[#FF6B7A]", date: "2026年3月", title: "数采/标注实习生", description: "在物智进化担任数采/标注实习生，制定标准化SOP与判准，日产出1800+位列实习生第一。", side: "left" },
  { id: 30, type: "主线任务", typeColor: "bg-[#FF6B7A]", date: "2026年3月", title: "AI获得实习offer", description: "第一次因为AI技能获得实习offer，证明了AI学习的价值。", side: "left" },
  ...
  { id: 34, type: "主线任务", typeColor: "bg-[#FF6B7A]", date: "2026年5月", title: "唯享科技测试实习生", description: "负责系统测试、文档编写与AI工作流搭建，掌握问题排查与流程搭建能力。", side: "left" },
  ...
  { id: 36, type: "主线任务", typeColor: "bg-[#FF6B7A]", date: "2026年6月", title: "拿到产品专家实习offer", description: "成功拿到理想的产品专家实习offer，开启职业新篇章。", side: "left" },
  ...
  { id: 38, type: "支线任务", typeColor: "bg-[#2F81F7]", date: "2026年7月", title: "从理想辞职", description: "上两天班后从理想辞职，知道这不是我想要的工作，更加明确了职业方向。", side: "right" },
  { id: 39, type: "主线任务", typeColor: "bg-[#FF6B7A]", date: "2026年7月", title: "找到火花工坊线上实习", description: "找到火花工坊线上实习AI产品经理岗位，开启AI产品领域的新篇章。", side: "left" },
